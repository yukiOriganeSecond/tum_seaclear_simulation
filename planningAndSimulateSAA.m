function [q,f,u,param_nominal,param_sim,find_feasible_solution] = planningAndSimulateSAA(param_base,seed_plan,seed_simulate,~)
    ...
    options = optimoptions(@fmincon, ...
        'MaxFunctionEvaluations',param_nominal.opt_MaxFunctionEvaluations, ...
        'Display',param_nominal.opt_Display, ...
        'PlotFcn',param_nominal.opt_PlotFcn, ...
        'SpecifyObjectiveGradient',true, ...
        'UseParallel',true, ...
        'EnableFeasibilityMode', false, ...
        'OptimalityTolerance',param_nominal.opt_OptimalityTolerance, ...
        'ScaleProblem',false, ...
        'StepTolerance',1e-12);
