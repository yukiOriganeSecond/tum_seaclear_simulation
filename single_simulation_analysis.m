...
visual.makeSnapsFB(q,q_nominal,q_nominal,x,x_nominal,x_nominal,param_nominal,t_vec,"po",[1],1:Nsim);
visual.plotRobotOutputsFB(x,param_nominal.xd,x_nominal,x_nominal,param_nominal,t_vec,[1,3;2,4],"po",1:Nsim);
visual.plotRobotStatesFB(q,q_nominal,q_nominal,param_nominal,t_vec,[1,5,7;2,6,8],"po",1:Nsim);
visual.plotInputs(u,f,param_nominal,t_vec,[1,2;3,4],"po",1:Nsim);
visual.plotInputsFB(u_nominal(:,:),u(:,:,:),u,param_nominal,t_vec,[1,2;3,4],"po",1:Nsim);