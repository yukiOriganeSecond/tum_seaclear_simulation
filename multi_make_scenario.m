...
scenario_setting_param.vessel_target_position_to_robot = true;      % false
...
scenario_setting_param.obs_y_min_distance = 0.8;                                               % keep this distance between y(0),yd and obstacles
